                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <form @submit.prevent="submit" class="space-y-6 p-6">
                        ...
                        <div v-if="form.scope_type === 'location'">
                            ...
                            <select id="scope_id" v-model="form.scope_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-brand-500 focus:ring-brand-500">
                        ...
                        <div v-if="form.recurrence === 'weekly'">
                            ...
                            <select id="day_of_week" v-model="form.day_of_week" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-brand-500 focus:ring-brand-500">
