                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium uppercase text-gray-500">Scope</th>
                                <th class="px-6 py-3 text-left text-xs font-medium uppercase text-gray-500">Dates</th>
                                <th class="px-6 py-3 text-left text-xs font-medium uppercase text-gray-500">Recurrence</th>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <tr v-for="rule in rules" :key="rule.id">
                                ...
                                <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-500 capitalize">{{ rule.scope_type }}</td>
                                ...
                                <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-500 capitalize">{{ rule.recurrence }}</td>
                                ...
                                <td v-if="isManager" class="whitespace-nowrap px-6 py-4 text-right text-sm">
                                    <Link :href="route('leagues.blackouts.edit', [league.slug, rule.id])" class="text-indigo-600 hover:text-indigo-900">Edit</Link>
