...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <Link :href="route('leagues.locations.edit', [league.slug, field.location.id])" class="text-sm text-indigo-600 hover:text-indigo-900">&larr; {{ field.location.name }}</Link>
